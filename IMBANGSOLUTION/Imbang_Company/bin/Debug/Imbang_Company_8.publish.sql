/*
Deployment script for Imbang_Companydb
...
GO
:setvar DatabaseName "Imbang_Companydb"
:setvar DefaultFilePrefix "Imbang_Companydb"
...
CREATE PROCEDURE [dbo].[CREATE]
    @Dname NVARCHAR(50), -- Changed to NVARCHAR for more flexibility
    @Dnumber INT,        -- Changed to INT to represent department number
    @Mgr_ssn NCHAR(10),
    @Mgr_start_date DATE
AS 
BEGIN
    ...
    INSERT INTO [dbo].[DEPARTMENT]
        ([Dnumber], [Dname], [Mgr_ssn], [Mgr_start_date]) -- Corrected column names
    VALUES 
        (@Dnumber, @Dname, @Mgr_ssn, @Mgr_start_date); -- Fixed values to match parameter names
END
GO
